  ...
  <div class="m-login">
    <Form ref="loginForm" :rules="validationLogin" :model="formInfo">
      ...
      <FormItem prop="userName" label="用户名">
        <Input placeholder="请输入用户名" v-model="formInfo.userName" clearable></Input>
      </FormItem>
      <FormItem prop="userPassword" label="密码">
        <Input type="password" placeholder="请输入密码" v-model="formInfo.userPassword" clearable></Input>
      </FormItem>
      <FormItem>
        <div class="remember">
...
export default class Login extends Vue {
  @Action('setUserInfo') setUserInfo!: (obj: Record<string, never>) => Record<string, never>
  ...
  validateUserPassword = (rule: string, value: string, callback: any) => {
    if (!value) {
